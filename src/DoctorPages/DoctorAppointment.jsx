...
import { Clock, Calendar, Video, MapPin, User, AlertCircle,Home } from "lucide-react";
  ...
  if (loading) {
   ...
   return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900 font-sans selection:bg-gray-200">
      ...
      {/* ================= Header ================= */}
      <header className="max-w-6xl mx-auto px-6 md:px-12 py-10 border-b border-gray-100 flex items-center justify-between">
        <div>
          <motion.h1
                ...
                >
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      {isTimeUp && (
                        <span className="bg-green-100 text-green-700 text-[10px] 
                                         font-bold px-2 py-1 rounded-full uppercase">
                          Live Now
                        </span>
                      )}
                    </div>
                  ...
                  <div className="mt-auto">
                    {isTimeUp ? (
                      ...
                      <div className="w-full bg-gray-100 text-gray-600 py-3.5 
                                      rounded-full text-xs font-mono text-center 
